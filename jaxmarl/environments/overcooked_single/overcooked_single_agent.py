...
class _OldOvercookedSingleAgent(MultiAgentEnv):
    ...
    def step_env(
        ...
        shaped_rewards = {"agent_0": shaped_rewards[self._active_agent_idx]}
...
from jaxmarl.environments.overcooked_single.overcooked import (
