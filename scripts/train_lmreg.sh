...
python -m baselines.IPPO.lmreg_fcp_overcooked_v2 --config-path=config/oc_extended/cpt_lmreg --config-name=coord_ring2
# python -m baselines.IPPO.lmreg_fcp_overcooked_v2 --config-path=config/oc_extended/cpt_lmreg --config-name=counter_circuit2