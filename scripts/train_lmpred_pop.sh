...
INIT_CHECKPOINTS_PREFIX="${INIT_CHECKPOINTS_PREFIX:-checkpoints/ph2v4/}"
PARTNER_CHECKPOINTS_PREFIX="${PARTNER_CHECKPOINTS_PREFIX:-checkpoints/ph2v4/}"
CHECKPOINTS_PREFIX="${CHECKPOINTS_PREFIX:-checkpoints/lmpred_pop/}"
