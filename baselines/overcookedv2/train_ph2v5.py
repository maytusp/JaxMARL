'''
Build on ph2v4.
Change "Other-Stream-CNN's parameters to be the EMA of Self-Stream-CNN's parameters insteadd of freezing them.
'''
import jax
...
def make_train(config, old_self_pool):
    ...
    def train(rng, seed_idx):
        ...
        other_stream_ema_decay = config.get("OTHER_STREAM_EMA_DECAY", 0.99)
